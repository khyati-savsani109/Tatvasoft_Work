...
<body>
		...
		<header class="header">
			...
			<img src="../assets/images/hero-banner-img.png" class="img-fluid">


		<br>

		<div class="container cont1 py-3">
			<h2>A Few words about us</h2>

			<center><img src="../assets/images/forma-1-copy-5.png"></center><br>
			<p></p>
			<p class="z5">Lorem ipsum dolor sit amet,consectetur adipiscing elit.Aenean molestie conavllis tempor.Duis vestibulum vel risus condimentum dictrum.
			<br>Orci varius natoque penatibus et margin dis parturient montes nascetur ridiculus mus.Vivarnus quis enim orci.Fusce risus lacus,
			sollicitudin eu magna sed,pharetra sodales libero.Proin tincudunt vel erat id portitor.Donec tristique est arcu,sed dignissim velit vulputate
			<br>ulticies.</p>

			<p class="z5">Interdum et malesuada farnes ac ante ipsum primis in faucibus.Inhaq habitasse platea dicturnus.Vivarnus eget mauris eget nisi euisrnod
			volutpat sed sed libero.Quisque sit amet lectus ex.Ut semper ligua et mauris tincident hendreit.Aenean ut rhoncus orci,vel elementum
			turpis.Donec tempor aliquet magna eu frigilla.Nam lobortis libero ut odio finibus lobortis.In hac habitasse platea dicturnst.Mauris a
			hendreit felis.Prasent ac vehicula ipsum,at porta tellus.Sed dolor alugue,posuere sed neque eget,aliquam ultricies velit.Sed lacus elit,
			tincident et massa ac,vehicula placerat lorem.</p>
		</div>
		...
		<div class="container cont1 py-3">
			...
			<p class="z5">Interdum et malesuada farnes ac ante ipsum primis in faucibus.Inhaq habitasse platea dicturnus.Vivarnus eget mauris eget nisi euisrnod
			volutpat sed sed libero.Quisque sit amet lectus ex.Ut semper ligua et mauris tincident hendreit.</p>
		</div>
